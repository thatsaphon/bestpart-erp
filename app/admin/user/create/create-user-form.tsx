...
export default function CreateUserForm({}: Props) {
    return (
        ...
        >
            ...
            <Input className="w-auto" name="username" />

            <span className="text-right">Password: </span>
            <Input className="w-auto" type="password" name="password" />

            <span className="text-right">ชื่อ: </span>
            <Input className="w-auto" name="first_name" />
            <span className="text-right">นามสกุล: </span>
            <Input className="w-auto" name="last_name" />
